...
CREATE TABLE "user" (
  ...
  "firstname" text NULL,
  "lastname" text NULL,
  "role" text DEFAULT 'membre', -- on créer cette nouvelle clé "role" qui a pour valeur par default "membre" : quiconque se crée un compte sur la plateforme devient un "membre"
  "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamptz
);
